...
public class LinkedInDemo {
    public static void run() {
        ...
        // Set user profile
        Profile profile = new Profile("Software Engineer","Passionate about coding and problem-solving.","sasacavav");
        ...
        for (User user : searchResults) {
            ...
            System.out.println("Headline: " + user.getProfile().getTitle());
            System.out.println();
        }
